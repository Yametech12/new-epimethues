...
export default function EncyclopediaPage() {
  ...
  const handleSaveImage = async () => {
    ...
    try {
      ...
      link.download = `epimetheus-profile-${profile.id}.png`;
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
      ...
      <div className="lg:col-span-3 space-y-4">
        <h2 className="text-sm font-medium text-slate-500 uppercase tracking-widest px-4 hidden lg:block">Personality Types</h2>
        <div className="flex lg:flex-col gap-2 overflow-x-auto lg:overflow-x-visible pb-4 lg:pb-0 px-4 lg:px-0 scrollbar-hide">
          {personalityTypes.map((type) => (
            ...
            >
              <span className="font-bold text-base lg:text-lg whitespace-nowrap">{type.name}</span>
              <span className="text-[10px] lg:text-xs font-mono opacity-60">{type.id}</span>
            </button>
          ))}
        </div>
      </div>
      ...
      <div className="lg:col-span-9 space-y-8">
        <div className="flex justify-end">
          ...
          >
            ...
            {isCapturing ? 'Capturing...' : 'Save Profile as Image'}
          </button>
        </div>
        <div ref={profileRef} className="glass-card p-8 md:p-12 space-y-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="space-y-2">
              ...
              <p className="text-xl text-accent-primary/80 font-medium italic">{profile.tagline}</p>
            </div>
            ...
            {activeTab === 'overview' && (
              <div className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <section className="space-y-4">
                    ...
                    <div className="text-slate-400 leading-relaxed">
                      <ReactMarkdown>{profile.howSheGetsWhatSheWants}</ReactMarkdown>
                    </div>
                  </section>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <section className="p-6 rounded-2xl bg-accent-primary/5 border border-accent-primary/10 space-y-4">
                    <h3 className="text-xl font-bold flex items-center gap-3 text-accent-primary">
                      <Heart className="w-6 h-6" />
                      What She Really Wants
                    </h3>
                    <div className="text-slate-300 leading-relaxed italic">
                      <ReactMarkdown>{profile.whatSheWants}</ReactMarkdown>
                    </div>
                  </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="p-6 rounded-2xl bg-white/5 border border-white/10 space-y-4">
                    ...
                    <div className="text-slate-400 text-sm leading-relaxed">
                      <ReactMarkdown>{profile.desires}</ReactMarkdown>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 rounded-2xl bg-accent-primary/5 border border-accent-primary/10 space-y-4">
                  <h4 className="font-bold text-lg flex items-center gap-2">
                    <HandMetal className="w-5 h-5 text-accent-primary" />
                    Compatibility
                  </h4>
                  <div className="text-slate-300 leading-relaxed">
                    <ReactMarkdown>{profile.compatibility}</ReactMarkdown>
                  </div>
                </div>
              </div>
            )}
            ...
            {activeTab === 'strategy' && (
              <div className="space-y-12">
                {[
                  ...
                  { label: 'Momentum', content: profile.strategy.momentum, example: profile.strategy.momentumExample, scenario: profile.strategy.momentumScenario, color: 'from-accent-primary to-accent-secondary' },
                  ...
                  <div key={i} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="space-y-4">
                        ...
                        <div className="p-4 rounded-xl bg-accent-primary/5 border border-accent-primary/10 italic text-slate-300">
                          "{p.example}"
                        </div>
                      </div>
                      <div className="space-y-2">
